...
HEADERS += \
    ...
    src/device_math.cuh \
    src/OrientedLinearCVMotionModel3D.h \
    src/kernels.cuh \
...
cuda.commands = $$CUDA_DIR/bin/nvcc -m64 -g -G -DTHRUST_DEBUG -O0 $$CUDA_GENCODE -dc $$NVCCFLAGS $$CUDA_INC $$CUDA_LIBS  ${QMAKE_FILE_NAME} -o ${QMAKE_FILE_OUT} \
